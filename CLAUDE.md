...
Growth Mentor: a personal growth tracking app for a builder and their students, built around a 10-year vision, goal management across health/soft-skills/education pillars, and weekly scorecards with AI-generated insights.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "34481950+nazmul636@users.noreply.github.com"
  git config user.name "nazmul636"
  ```
